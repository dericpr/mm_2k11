...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/cuf_run.js"></script>
		 ...
		 function updateMain()
		 {
			 $('#charinfo').html("This is your Character info based on the character you have selected.  If you wish to change your character you're going to have to contact <a href='mailto:greg@mysteryparty.net'>Greg</a> or <a href='mailto:dericpr@mysteryparty.net'>Deric</a> and ask them to make a change.  Since each character is written specifically for the player who has selected them we can't just re-assign a character without some consideration.  Thanks<br><br>");
			 $.post('getchardata.php', function(data) {
				 if ( data.res == 1 ) {
					 $('#charinfo').append(data.content).fadeIn('slow');
			 	}
			 }, "json");
		 }
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<div class="article">
			<div id='sponsor_article'>
            <h2><span>Character Info</span></h2>
          <div class="clr"></div>
          <p>Posted on 12. Oct, 2011 by Deric </p>
          <div class="clr"></div>
			<p>
	  ...
	  if ($_SESSION['paid'] == 0 )
	  {
       ...
       echo " <input type='hidden' name='item_name' value='Murdery Mystery Payment'>";
